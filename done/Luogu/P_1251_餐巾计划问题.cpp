...
void solve() {
    ...
    rep (i, 0, n) {
        int r; cin >> r;
        G.add_edge(s, i, r, 0);
        G.add_edge(i + n, t, r, 0);
    }
    int p, m, f, d, c; cin >> p >> m >> f >> d >> c;
    rep (i, 0, n) {
        if (i != n - 1) G.add_edge(i, i + 1, IINF, 0);
        G.add_edge(s, i + n, IINF, p);
        if (i + m < n) G.add_edge(i, i + m + n, IINF, f);
        if (i + d < n) G.add_edge(i, i + d + n, IINF, c);
    }
    cout << G.flow(s, t).se << '\n';
}
